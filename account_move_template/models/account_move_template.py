...
class AccountMoveTemplate(models.Model):
    ...
    line_ids = fields.One2many(
        "account.move.template.line", inverse_name="template_id", string="Lineas"
    )
...
class AccountMoveTemplateLine(models.Model):
    ...
    template_id = fields.Many2one(
        "account.move.template", string="Plantilla Asiento", ondelete="cascade"
    )
    ...
    analytic_account_id = fields.Many2one(
        "account.analytic.account", string=u"Cuenta Analítica"
    )
    analytic_tag_ids = fields.Many2many("account.analytic.tag", string=u"Etiquetas Analíticas")
    tax_ids = fields.Many2many("account.tax", string="Impuesto")
    tax_line_id = fields.Many2one(
        "account.tax", string="Originator Tax", ondelete="restrict"
    )
    company_id = fields.Many2one(related="template_id.company_id", store=True, string=u"Compañia")
    ...
    type = fields.Selection(
        [("computed", "Computado"), ("input", "Sistema")],
        required=True,
        default="input",
        string=u"Tipo"
    )
    ...
    move_line_type = fields.Selection(
        [("cr", "Haber"), ("dr", "Debe")], required=True, string=u"Direccción"
    )
